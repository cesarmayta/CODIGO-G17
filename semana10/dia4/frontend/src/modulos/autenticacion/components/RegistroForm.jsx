    ...
    return (
        <div className="uk-container">
            ...
            <div className="uk-width-1-3@m m-auto my-16">
                <div className="mb-4">
                    <h2 className="mb-0">Create a new <span className="uk-text-bold">account</span></h2>
                    <p className="my-0"> Register to manage your account.</p>
                </div>
                <form onSubmit={onSubmitRegister}>
                    ...
                    <div className="uk-form-group  mb-0">
                        ...
                        <div className="uk-inline w-full">
                            ...
                            <input className="uk-input" type="password" name="password2" placeholder="********" onChange={handleInputChange} />
                        </div>
                    ...
                    <div className="uk-flex-middle" uk-grid>
                        <div className="uk-width-expand@s">
                            <p> Do you have an account <Link to="/iniciar-sesion">Sign in</Link></p>
                        </div>
